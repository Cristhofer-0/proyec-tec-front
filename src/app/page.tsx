...
import Eventos from "./carrusel-eventos/eventos";
import {
  ChevronLeft,
  ChevronRight,
  Calendar,
...
export default async function Home() {
  ...
  // Tomamos los tres primeros eventos como ejemplo
  const [evento1, evento2, evento3] = eventos
              ...
              <Card key={index} className="overflow-hidden transition-all hover:shadow-lg">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center text-gray-500 mb-1">
                    ...
                    <span>{evento.fechaFinalizacion}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-lg font-bold text-purple-600">€{evento.categorias}</div>
